...
public class Beach implements Comparable<Beach> {
    ...
    {
        Beach entry = o;
        int distanceComparison = (int)(distance - o.getDistance());
        int qualityComparison = quality - o.getQuality();
        return 10000 * name.compareTo(o.getName()) + 100 * distanceComparison + qualityComparison;
